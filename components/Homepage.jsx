    ...
    <>
      <div className="pt-8 flex flex-col md:items-start md:px-[20vw] lg:px-0 lg:flex-row lg:justify-between">
        <div className="lg:flex lg:flex-col">
          <h1 className="flex flex-col items-center ml-[-1vw] text-8xl  tracking-tighter title-line-height md:text-9xl lg:pt-8">
            Ben <br /> Schroeder
          </h1>
          <h2 className="text-5xl grey-text pt-4">Poet</h2>
        </div>
