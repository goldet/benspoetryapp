        ...
        <div className={styles.subsection}>
          ...
          <div className={styles.entries}>
            <div className={styles.entry}>
              ...
              <div className={styles.position}>
                Máster propio in International Education
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={styles.subsection}>
          ...
          <div className={styles.entries}>
            ...
            <div className={styles.entry}>
              ...
              <div className={styles.company}>
                CYFAR & REACH Military Families Lab
              </div>
              <div className={styles.position}>
                Undergraduate Research Assistant, Copyeditor
              </div>
            </div>
          </div>
        </div>
        <div className={styles.subsection}>
          ...
          <div className={styles.entries}>
            <div className={styles.entry}>
              <div className={styles.date}>2017-2018</div>
              <div className={styles.company}>
                Univeristy of Minnesota - English Department
              </div>
        ...
        <div className={styles.subsection}>
          ...
          <div className={styles.entries}>
            <div className={styles.entry}>
              ...
              <div className={styles.company}>
                CEIP Fernando de los Ríos - Madrid, Spain
              </div>
            ...
            <div className={styles.entry}>
              <div className={styles.date}>2020-2021</div>
              <div className={styles.company}>
                CEIP Fuente Santa - Madrid, Spain
              </div>
              <div className={styles.position}>Auxiliar de Conversación</div>
            </div>
            <div className={styles.entry}>
              <div className={styles.date}>2020-2021</div>
              <div className={styles.company}>
                C.R.A. Entreviñas - La Rioja, Spain
              </div>
              <div className={styles.position}>Auxiliar de Conversación</div>
            </div>
          </div>
        ...
        <div className={styles.subsection}>
          ...
          <div className={styles.entries}>
            ...
            <div className={styles.entry}>
              ...
              <div className={styles.company}>& Change, Forthcoming</div>
              <div className={styles.position}>
                &quot;[Oh, sleepsmile, spark of rub against].&quot;
              </div>
            </div>
            <div className={styles.entry}>
            ...
            <div className={styles.entry}>
              ...
              <div className={styles.position}>
                Winner of the 2018 ArtWords Contest
              </div>
            </div>
            <div className={styles.entry}>
              <div className={styles.date}>2018</div>
        ...
        <div className={styles.subsection}>
          ...
          <div className={styles.entries}>
            <div className={styles.entry}>
              ...
              <div className={styles.position}>
                &quot;Wheel in Large Circles&#39;: Whitman&#39;s Spiral
                Poetics.&quot;
              </div>
            </div>
          </div>
        ...
        <div className={styles.subsection}>
          ...
          <div className={styles.entries}>
            <div className={styles.entry}>
              ...
              <div className={styles.position}>
                &quot;A Theater of the Impossible: The Problem with &#39;Call Me
                by Your Name.&#39;&quot;
              </div>
            </div>
          </div>
        ...
        <div className={styles.subsection}>
          ...
          <div className={styles.entries}>
            <div className={styles.entry}>
              ...
              <div className={styles.position}>
                &quot;The Variable of Absence: A Review of Caitlin Bailey&#39;s
                Solve for Desire.&quot;
              </div>
            </div>
          </div>
        ...
        <div className={styles.subsection}>
          ...
          <div className={styles.entries}>
            <div className={styles.entry}>
              <div className={styles.date}>2018</div>
              <div className={styles.company}>
                A Place at the Table Undergraduate English Conference,
            ...
            <div className={styles.entry}>
              ...
              <div className={styles.company}>
                Adventures in English Undergraduate English Conference,
                University of Minnesota Twin Cities, Minneapolis
              </div>
            ...
            <div className={styles.entry}>
              <div className={styles.date}>2016</div>
              <div className={styles.company}>
                Celebrate English Undergraduate English Conference, University
        ...
        <div className={styles.subsection}>
          ...
          <div className={styles.entries}>
            <div className={styles.entry}>
              <div className={styles.date}>2017</div>
              <div className={styles.company}>
                West Bank Arts Festival, University of Minnesota Twin Cities,
                Minneapolis
              </div>
              <div className={styles.position}>
        ...
        <div className={styles.subsection}>
          ...
          <div className={styles.entries}>
            <div className={styles.entry}>
              <div className={styles.date}>2017</div>
              <div className={styles.position}>
                Awarded $4,000 by Donald V. Hawkins Scholarship
              </div>
            </div>
            <div className={styles.entry}>
              <div className={styles.date}>2016</div>
              <div className={styles.position}>
                Awarded $1,000 by Joan C. Forester Scholarship for Excellence in
                Literary Studies
              </div>
            </div>
            <div className={styles.entry}>
              ...
              <div className={styles.position}>
                Awarded $14,000 by Kohler Co. Dependent of Kohler Employee
        ...
        <div className={styles.subsection}>
          ...
          <div className={styles.entries}>
            <div className={styles.entry}>
              <div className={styles.date}>2017</div>
              <div className={styles.position}>
                Awarded $1,500 from the Undergraduate Research Opportunities
                Program (UROP) to write <i>Exhibit A</i>, a poetry chapbook.
              </div>
            </div>
            <div className={styles.entry}>
              <div className={styles.date}>2017</div>
              <div className={styles.position}>
                Awarded $1,500 from the Undergraduate Research Opportunities
                Program (UROP) to write <i>Apomictic Man</i>, a poetry chapbook.
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="px-10">
        ...
        <div className={styles.subsection}>
          ...
          <div className={styles.entries}>
            <div className={styles.entry}>
              <div className={styles.position}>
                Professional reading, speaking, and writing skills
              </div>
            </div>
          </div>
        </div>
